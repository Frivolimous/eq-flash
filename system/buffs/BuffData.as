	...
	public class BuffData{
		...
		public static function makeBuff(label:String,level:int=0):BuffBase{
			...
			switch (label){
				...
				case LEAP_ATTACK: return new BuffStats(-1,label,level,BuffBase.BUFF,1,[[SpriteModel.ATTACK,ActionBase.DODGE_REDUCE,0.02*level],[SpriteModel.STAT,StatModel.DMGMULT,0.1*level]]);
