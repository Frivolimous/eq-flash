package system.actions{
	...
	public class ActionPotionHealing extends ActionBase{
		public function ActionPotionHealing(_label:String=null,_level:int=0,_damage:Number=0,_effects:Vector.<EffectBase>=null){
			if (_label!=null){
				baseStats();
				label=_label;
				level=_level;
