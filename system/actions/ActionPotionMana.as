package system.actions{
	...
	public class ActionPotionMana extends ActionBase{
		public function ActionPotionMana(_label:String=null,_level:int=0,_damage:Number=0,_effects:Vector.<EffectBase>=null){
			if (_label!=null){
				baseStats();
				label=_label;
				level=_level;
		...
		override public function modify(_v:SpriteModel,_random:Boolean=true):ActionBase{
			...
			if (source.secondary!=ItemData.MANA) m.damage*=_v.stats.getValue(StatModel.HEALMULT);
