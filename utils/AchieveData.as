package utils {
  ...
  import items.ItemData;
    ...
    public static const ACHIEVE_DEFS:Array=[
      ...
      {steamName: "DUEL_500", displayText: "Arena Level: 500", awardDesc: "So you probably know this by now, but the arena is a great place to make gold. You have defeated level 500, which is like... 100 guys!"},
    ...
    public static function checkCompleteAll():void {
      for (var i=0;i<COMPLETE_ALL;i+=1){
        if (GameData.achievements[i]==false) return;
      }
