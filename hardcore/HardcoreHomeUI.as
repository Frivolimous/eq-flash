package hardcore{
	...
	public class HardcoreHomeUI extends BaseUI{
		...
		public function goAdventure(){
			Facade.gameC=new HardcoreGameControl();
			Facade.gameUI.transTo=this;
			new FadeTransition(this,Facade.gameUI);
		}
		
		public function popRules(){
			new ScrollAnnounce("<b>Warrior Challenge Mode!</b>\n Dates: August 15 2017 to September 2 2017, 11:59 EST\n\nTest your skills with Warrior building in this unique challenge mode!\n\n<b>Rules:</b>\n- Hardcore Mode: if you die you must restart\n- Only 2 monsters per zone\n- Every monster Drops and one Premium Drop after the boss\n- All monsters have increased health and monster damage does not scale past zone 1000\n- All drops have suffixes\n- Chance for any crafted item to drop\n- Only Tanking and Strength Items will drop\n- Item Level goes up to 25 maximum\n- Character Level goes up to 70 maximum\n- Artifact Level goes up to 10 maximum\n- No Shadow Realm\n\n<b>Milestone Rewards instantly earned:</b>\nz100: 5pt ; z200: Minor Chaos Essence ; z400: 10pt ; z700: Chaos Essence ; z1000: 15pt ; z1500: Essence ; z2000: 20pt ; z2500: Epic Essence ; z3000: 25pt ; z4000 Essence x5\n\n<b>Ladder Rewards, earned at the end of the event</b>\n<b>Rank 1:</b> Trophy, 1 Epic Essence, 2 Essences, 3 Chaos Essences, 30 Power Tokens\n<b>Rank 2:</b> Trophy, 2 Essences, 2 Chaos Essences, 25 Power Tokens\n<b>Rank 3:</b> Trophy, 1 Essence, 2 Chaos Essences, 20 Power Tokens\n<b>Rank 4-10:</b> Trophy, 2 Chaos Essences\n<b>Rank 11-25:</b> Trophy, 1 Chaos Essence\n<b>Rank 26-50:</b> Participation Award, 1 Minor Chaos Essence\n<b>Participant:</b> Participation Award\n");
		...
		public function navOut(i:int=0){
			...
			GameData._Save=SharedObject.getLocal("OPTIONS");
		...
		override public function openWindow(){
			...
			if (Facade.gameM.playerM.saveSlot==SAVESLOT){
				...
				GameData._Save=SharedObject.getLocal("HC_OPTIONS");
				if (GameData._Save.size==0){
					GameData.resetSave();
