	...
	public class ArtifactData{
		...
		public static function getDesc(s:String):String{
			switch(s){
				...
				case DRAGON: return "Our knowledge is insignificant compared to ancient wisdom. The dragon within ascends from our spirit, gifting the artifacts of truth to those that treasure the ancient ways and study them all their days.";
				case BLOOD: return "A gallery of beasts was fashioned from our fear of the unknown. As we ascend in perspective their mysteries are revealed and grants us power, in knowing the psychology of man and what the darkness holds over them.";
				...
				case MATRIX: return "You are trapped in an illusion, a construct of the mind. Once you realize that what you think you know is but a shadow on the wall, your mind will be freed and you will leave the cave of your own creation."
				default: return "";
			}
		}
	}
